...
const translations = {
    "tr": { // Türkçe
        ...
        "portfolio_github_btn": "GitHub Repository",
        "project_mooweather_mobile_name": "MooWeather-Mobile",
        "project_mooweather_mobile_desc": "Premium, tam yığın hava durumu uygulaması. Glassmorphism arayüzü, Google Sign-In, dinamik temalar, çoklu dil desteği ve bulut senkronizasyonu ile geliştirildi.",
        "project_mooweather_backend_name": "MooWeather-BackEnd",
        "project_mooweather_backend_desc": "MooWeather mobil uygulaması için özel geliştirilmiş C# .NET Backend REST API. JWT kimlik doğrulaması, OpenWeatherMap veri analizi ve kullanıcı bulut senkronizasyonunu yönetir.",
        "project_portfolio_name": "Bu Portfolyo Sitesi",
        "project_portfolio_desc": "Modern, responsive ve PWA destekli kişisel portfolyo sitesi. Çoklu dil desteği (TR/EN/ES), karanlık/aydınlık tema, servis worker ve akıcı animasyonlarla geliştirildi.",
        "project_discord_bot_name": "Göktürk Ordusu Bot",
        "project_discord_bot_desc": "Göktürk Ordusu topluluğu için geliştirilmiş resmi Discord botu. Sunucu yönetimi, kullanıcı etkileşimi ve otomatik moderasyon özelliklerini sağlar.",
    ...
    "en": { // İngilizce
        ...
        "portfolio_github_btn": "GitHub Repository",
        "project_mooweather_mobile_name": "MooWeather-Mobile",
        "project_mooweather_mobile_desc": "Premium, full-stack weather application. Developed with glassmorphism UI, Google Sign-In, dynamic themes, multi-language support and cloud synchronization.",
        "project_mooweather_backend_name": "MooWeather-BackEnd",
        "project_mooweather_backend_desc": "Custom-built C# .NET Backend REST API for MooWeather mobile app. Manages JWT authentication, OpenWeatherMap data analysis and user cloud sync.",
        "project_portfolio_name": "This Portfolio Site",
        "project_portfolio_desc": "Modern, responsive and PWA-supported personal portfolio website. Developed with multi-language support (TR/EN/ES), dark/light theme, service worker and smooth animations.",
        "project_discord_bot_name": "Göktürk Ordusu Bot",
        "project_discord_bot_desc": "Official Discord bot developed for the Göktürk Ordusu community. Provides server management, user interaction and automated moderation features.",
    ...
    "es": { // İspanyolca
        ...
        "portfolio_github_btn": "Repositorio GitHub",
        "project_mooweather_mobile_name": "MooWeather-Mobile",
        "project_mooweather_mobile_desc": "Aplicación meteorológica premium de pila completa. Desarrollada con interfaz de usuario de glassmorphism, Google Sign-In, temas dinámicos, soporte en varios idiomas y sincronización en la nube.",
        "project_mooweather_backend_name": "MooWeather-BackEnd",
        "project_mooweather_backend_desc": "API REST de backend de C# .NET personalizada para la aplicación móvil MooWeather. Administra la autenticación JWT, el análisis de datos de OpenWeatherMap y la sincronización en la nube del usuario.",
        "project_portfolio_name": "Este sitio de portafolio",
        "project_portfolio_desc": "Sitio web de portafolio personal moderno, adaptable y compatible con PWA. Desarrollado con soporte en varios idiomas (TR/EN/ES), tema oscuro/claro, service worker y animaciones fluidas.",
        "project_discord_bot_name": "Göktürk Ordusu Bot",
        "project_discord_bot_desc": "Bot oficial de Discord desarrollado para la comunidad Göktürk Ordusu. Proporciona gestión de servidores, interacción de usuarios y funciones de moderación automatizada.",
